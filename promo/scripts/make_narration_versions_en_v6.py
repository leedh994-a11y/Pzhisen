#!/usr/bin/env python3
"""Generate EN narrations for promo pack v6 — unique scripts/voices vs all prior packs (v1–v5)."""
...
ASSETS = ROOT / "assets" / "versions-en-v6"
...
VERSIONS: list[dict] = [
    {
        ...
        "pitch": "-1Hz",
        "cues": [
            "Austin here — a U.S. product founder out of Seattle who builds always-on growth systems for operators who hate busywork.",
            "Over the next couple of minutes I'll show you how anyone can use the AI agents at pzhisen.online with almost zero friction.",
            "The whole experience is tuned for convenience: you move fast, you ship fast, and you skip the usual setup maze.",
            ...
            "After go-live, those agents keep working every day of the year, twenty-four hours a day.",
    ...
    },
    {
        ...
        "pitch": "+1Hz",
        "cues": [
            "Howdy — I'm Garrett, an American operator based in Texas who turns brands into machines that sell while the founder steps away.",
            "Let me walk you through why pzhisen.online is the fastest way to put tireless AI marketing on your payroll.",
            "Everything about the product feels convenient, rapid, and built for people who refuse to waste time.",
    ...
    },
    {
        ...
        "pitch": "+3Hz",
        "cues": [
            "Hey — Wesley speaking. I'm a U.S. coastal founder who scales lifestyle brands with automation that never takes a vacation.",
    ...
    },
    {
        ...
        "pitch": "-5Hz",
        "cues": [
            "Good afternoon — Spencer here. I'm a U.S. finance-minded founder who builds disciplined, compounding acquisition systems for serious operators.",
            "In this briefing I'll show exactly how anyone can run Pzhisen at pzhisen.online as a full AI marketing engine.",
    ...
    },
    {
        ...
        "pitch": "+5Hz",
        "cues": [
            "Hello, I'm Elliot — an American mountain-state founder focused on lean teams and automation that works while you hike offline.",
...
async def build_version(ver: dict) -> float:
    ...
    with tempfile.TemporaryDirectory(prefix=f"pzhisen-v6-{vid}-tts-") as tmp:
        tmp_path = Path(tmp)
        parts: list[Path] = []
