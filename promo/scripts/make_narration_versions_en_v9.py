#!/usr/bin/env python3
"""Generate EN narrations for promo pack v9 — unique scripts/voices vs all prior packs (v1–v8)."""
...
ASSETS = ROOT / "assets" / "versions-en-v9"
...
VERSIONS: list[dict] = [
    {
        ...
        "pitch": "-2Hz",
        "cues": [
            "Fletcher here — a Chicago-based American founder who builds always-on acquisition engines for operators who hate babysitting ads.",
            "I'm going to explain, in clear practical detail, how anyone can use the AI agents at pzhisen.online with almost zero friction.",
            "The product is engineered for convenience: you move quickly, you ship quickly, and you skip the usual onboarding drag.",
    ...
    },
    {
        ...
        "pitch": "+4Hz",
        "cues": [
            "I'm Camden — an American founder from Austin who turns brands into nonstop selling systems so the team can stay focused on the craft.",
            "Let me walk you through, step by step, why pzhisen.online is the fastest route to tireless AI marketing on your side.",
            "Everything about the experience feels convenient, rapid, and built for people who refuse wasted clicks.",
    ...
    },
    {
        ...
        "pitch": "-7Hz",
        "cues": [
            "Hey — Sterling speaking. I'm a New York Midtown founder who scales consumer brands with automation that never takes a day off.",
            "I'll break down, clearly and specifically, how pzhisen.online lets anyone deploy AI agents for nonstop marketing automation.",
    ...
    },
    {
        ...
        "pitch": "+6Hz",
        "cues": [
            "Good day — Beckett here. I'm a Portland-based American founder who builds calm, compounding growth systems for serious operators.",
    ...
    },
    {
        ...
        "pitch": "+3Hz",
        "cues": [
            "Hello, I'm Harlan — an American Arizona founder focused on lean teams and automation that keeps selling while leadership is offline.",
...
async def build_version(ver: dict) -> float:
    ...
    with tempfile.TemporaryDirectory(prefix=f"pzhisen-v9-{vid}-tts-") as tmp:
        tmp_path = Path(tmp)
        parts: list[Path] = []
