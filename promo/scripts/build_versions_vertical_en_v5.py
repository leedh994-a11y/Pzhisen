#!/usr/bin/env python3
"""Build NEW 5 vertical EN promo MP4s — pack v5 (unique presenters/scripts/UI vs prior packs)."""
...
VERSION_META = [
    {
        ...
        "subtitle_fs": 37,
        "subtitle_margin_v": 158,
        "subtitle_primary": "&H00E2E8F0",
        "drift_cycle": ["center", "left", "up", "center", "left", "up", "center", "left", "up", "center", "left", "center"],
        "zoom_alt": False,
    },
    {
        "id": "v2",
        ...
        "drift_cycle": ["up", "center", "left", "up", "center", "left", "up", "center", "left", "up", "center", "up"],
        "zoom_alt": True,
    },
    {
        "id": "v3",
        ...
        "subtitle_primary": "&H00ECFEFF",
        "drift_cycle": ["left", "up", "center", "left", "up", "center", "left", "up", "center", "left", "center"],
        "zoom_alt": False,
    },
    {
        "id": "v4",
        ...
        "drift_cycle": ["center", "up", "left", "center", "up", "left", "center", "up", "left", "center", "up"],
        "zoom_alt": True,
    },
    {
        "id": "v5",
...
def build_one(meta: dict) -> Path:
    ...
    outfile = OUT_DIR / f"pzhisen-promo-en5-{vid}-vertical.mp4"

    scenes = scene_plan(duration, ver_dir, meta)
    print(f"\n=== Building v5 {vid} ({meta['name']}) {duration:.1f}s vertical ===")

    drifts = meta["drift_cycle"]
    zoom_alt = meta["zoom_alt"]
    zoom_speed = {"v1": 0.00110, "v2": 0.00090, "v3": 0.00140, "v4": 0.00100, "v5": 0.00125}[vid]

    with tempfile.TemporaryDirectory(prefix=f"pzhisen-en5-{vid}-") as tmp:
        tmp_path = Path(tmp)
        clips: list[Path] = []
...
def main() -> None:
    ...
    for meta in VERSION_META:
        if only != "all" and only != meta["id"]:
            continue
        build_one(meta)
    print("\nAll v5 unique vertical videos built.")
