#!/usr/bin/env python3
"""Build NEW 5 vertical EN promo MP4s — pack v7 (unique presenters/scripts/UI vs prior packs)."""
...
VERSION_META = [
    {
        ...
        "subtitle_primary": "&H00F5F0E8",
        "drift_cycle": ["center", "left", "up", "center", "left", "up", "center", "left", "up", "center", "left"],
        "zoom_alt": False,
        "zoom_speed": 0.00110,
    },
    {
        ...
        "subtitle_fs": 36,
        "subtitle_margin_v": 154,
        "subtitle_primary": "&H00E8F1FF",
        "drift_cycle": ["up", "center", "right", "up", "center", "left", "up", "center", "right", "up", "center"],
        "zoom_alt": True,
        "zoom_speed": 0.00098,
    },
    {
        ...
        "subtitle_primary": "&H00FFF8F0",
        "drift_cycle": ["left", "up", "center", "right", "up", "left", "center", "up", "right", "left", "center", "up"],
        "zoom_alt": False,
        "zoom_speed": 0.00125,
    },
    {
        ...
        "subtitle_fs": 34,
        "subtitle_margin_v": 126,
        "subtitle_primary": "&H00ECFDF5",
        "drift_cycle": ["right", "center", "up", "left", "center", "up", "right", "center", "up", "left", "center"],
        "zoom_alt": True,
        "zoom_speed": 0.00108,
    },
    {
...
def build_one(meta: dict) -> Path:
    ...
    outfile = OUT_DIR / f"pzhisen-promo-en7-{vid}-vertical.mp4"

    scenes = scene_plan(duration, ver_dir, meta)
    print(f"\n=== Building v7 {vid} ({meta['name']}) {duration:.1f}s vertical ===")

    drifts = meta["drift_cycle"]
    zoom_alt = meta["zoom_alt"]
    zoom_speed = meta["zoom_speed"]

    with tempfile.TemporaryDirectory(prefix=f"pzhisen-en7-{vid}-") as tmp:
        tmp_path = Path(tmp)
        clips: list[Path] = []
...
def main() -> None:
    ...
    for meta in VERSION_META:
        if only != "all" and only != meta["id"]:
            continue
        build_one(meta)
    print("\nAll v7 unique vertical videos built.")
