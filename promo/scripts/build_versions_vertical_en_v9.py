#!/usr/bin/env python3
"""Build NEW 5 vertical EN promo MP4s — pack v9 (unique presenters/scripts/UI vs prior packs)."""
...
VERSION_META = [
    {
        ...
        "subtitle_fs": 36,
        "subtitle_margin_v": 148,
        "subtitle_primary": "&H00FFF4E6",
        "drift_cycle": ["center", "up", "left", "center", "up", "right", "center", "up", "left", "center", "up"],
        "zoom_alt": False,
        "zoom_speed": 0.00098,
    },
    {
        ...
        "subtitle_fs": 35,
        "subtitle_margin_v": 162,
        "subtitle_primary": "&H00FFF1E8",
        "drift_cycle": ["right", "center", "up", "left", "center", "up", "right", "center", "up", "left", "right"],
        "zoom_alt": True,
        "zoom_speed": 0.00118,
    },
    {
        ...
        "subtitle_fs": 37,
        "subtitle_margin_v": 134,
        "subtitle_primary": "&H00F8F8FF",
        "drift_cycle": ["up", "right", "center", "up", "left", "center", "up", "right", "center", "up", "left", "up"],
        "zoom_alt": False,
        "zoom_speed": 0.00108,
    },
    {
        ...
        "subtitle_fs": 34,
        "subtitle_margin_v": 172,
        "subtitle_primary": "&H00ECFDF5",
        "drift_cycle": ["left", "up", "center", "right", "up", "center", "left", "up", "center", "right", "up"],
        "zoom_alt": True,
        "zoom_speed": 0.00128,
    },
    {
        ...
        "subtitle_fs": 38,
        "subtitle_margin_v": 186,
        "subtitle_primary": "&H00FFFBEB",
        "drift_cycle": ["center", "right", "up", "center", "left", "up", "center", "right", "up", "center", "left"],
        "zoom_alt": False,
        "zoom_speed": 0.00088,
    },
]
...
def build_one(meta: dict) -> Path:
    ...
    outfile = OUT_DIR / f"pzhisen-promo-en9-{vid}-vertical.mp4"

    scenes = scene_plan(duration, ver_dir, meta)
    print(f"\n=== Building v9 {vid} ({meta['name']}) {duration:.1f}s vertical ===")

    drifts = meta["drift_cycle"]
    zoom_alt = meta["zoom_alt"]
    zoom_speed = meta["zoom_speed"]

    with tempfile.TemporaryDirectory(prefix=f"pzhisen-en9-{vid}-") as tmp:
        tmp_path = Path(tmp)
        clips: list[Path] = []
...
def main() -> None:
    ...
    for meta in VERSION_META:
        if only != "all" and only != meta["id"]:
            continue
        build_one(meta)
    print("\nAll v9 unique vertical videos built.")
