#!/usr/bin/env python3
"""Generate EN narrations for promo pack v7 — unique scripts/voices vs all prior packs (v1–v6)."""
...
ASSETS = ROOT / "assets" / "versions-en-v7"
...
VERSIONS: list[dict] = [
    {
        ...
        "pitch": "+2Hz",
        "cues": [
            "Chandler here — a New York founder who builds nonstop acquisition engines for operators who refuse to babysit marketing.",
            "In the next few minutes I'll walk you through, in concrete detail, how anyone can use the AI agents at pzhisen.online with almost no friction.",
            "The product is engineered for convenience: you move quickly, you publish quickly, and you skip the usual setup drag.",
            "Open pzhisen.online, share a short brief about your business, and launch your AI employee team in minutes. Setup stays light. No credit card is required to begin.",
            "After you go live, those agents keep working every day of the year, twenty-four hours a day.",
            "They do not sleep. They do not rest. They do not power down.",
    ...
    },
    {
        ...
        "pitch": "-2Hz",
        "cues": [
            "I'm Brooks — an American founder out of Chicago who turns brands into always-on selling systems so the team can focus on the product.",
            "Let me show you, step by step, why pzhisen.online is the quickest path to tireless AI marketing on your side.",
            "Everything about the experience feels convenient, rapid, and built for people who hate wasted clicks.",
    ...
    },
    {
        ...
        "pitch": "+4Hz",
        "cues": [
            "Hey — Hayden speaking. I'm a U.S. West Coast founder who scales consumer brands with automation that never takes a day off.",
    ...
    },
    {
        ...
        "pitch": "-3Hz",
        "cues": [
            "Good day — Reid here. I'm a U.S. Pacific Northwest founder who builds calm, compounding growth systems for serious operators.",
    ...
    },
    {
        ...
        "pitch": "-1Hz",
        "cues": [
            "Hello, I'm Nash — an American Southeast founder focused on lean teams and automation that keeps selling while leadership is offline.",
...
async def build_version(ver: dict) -> float:
    ...
    with tempfile.TemporaryDirectory(prefix=f"pzhisen-v7-{vid}-tts-") as tmp:
        tmp_path = Path(tmp)
        parts: list[Path] = []
