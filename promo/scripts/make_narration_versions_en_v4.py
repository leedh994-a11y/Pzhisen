#!/usr/bin/env python3
"""Generate EN narrations for promo pack v4 — unique scripts/voices vs all prior packs."""
...
ASSETS = ROOT / "assets" / "versions-en-v4"

# Five fully distinct scripts — same product facts, different spoken wording.
# Presenters / voices intentionally unused in v1–v3 packs.
VERSIONS: list[dict] = [
    {
        "id": "v1",
        "name": "Derek",
        ...
        "pitch": "+1Hz",
        "cues": [
            "Derek here — a U.S. founder who builds automated growth systems for brands across America.",
            "I'm going to show you, in plain English, how anyone can use the AI agents at pzhisen.online with almost zero friction.",
            "This site is built for convenience: you move fast, you get results quickly, and you are not stuck in setup hell.",
            "Open pzhisen.online, describe your business in a few lines, and launch your AI employee team in minutes. Light setup. No credit card required to start.",
            "After that, the agents keep working every single day of the year, twenty-four hours a day.",
            "They never sleep. They never rest. They never clock out.",
            ...
            "They create promotional marketing copy and send it into mainstream email worldwide — Gmail, Outlook, and other major inboxes.",
            "They automatically reply to customer-service messages so support stays live around the clock.",
            ...
            "Whether you own a personal website or a company website, Pzhisen can help anyone on Earth promote and market on full automation.",
            ...
            "Want a team that never stops? Go to pzhisen.online and start now.",
        ],
    },
    {
        "id": "v2",
        ...
        "pitch": "-2Hz",
        "cues": [
            "Hey, I'm Cole — an American operator who scales content and conversion for founders who hate wasted hours.",
            "Let me walk you through why pzhisen.online is the fastest way to put always-on AI marketing to work for you.",
            "The whole experience feels convenient, rapid, and designed for people who need speed.",
            "Visit the site, tell it what you sell, and stand up an AI employee squad in minutes — minimal configuration, and you can begin without a credit card.",
            "From that point, those agents keep executing all day, every day, all year.",
            "Zero sleep. Zero break time. Zero downtime.",
            "Pzhisen agents craft promotional marketing tweets and captions automatically.",
            "They assemble promotional marketing videos you can publish immediately.",
            ...
            "Open pzhisen.online today and put tireless AI agents on your growth.",
        ],
    },
    {
        "id": "v3",
        ...
        "pitch": "-1Hz",
        "cues": [
            "Good afternoon. Vincent speaking — a U.S. executive focused on revenue systems that run without constant human babysitting.",
            "I'll explain step by step how pzhisen.online lets anyone deploy AI agents for nonstop marketing automation.",
            "Using the platform is intentionally convenient — quick to start and easy to keep running.",
            "Go to pzhisen.online, outline your business, and deploy your AI employee team within minutes. Setup stays light, and you can begin without entering a credit card.",
            "Once live, the agents continue through every hour of every day across the full calendar year.",
            "No sleep cycles. No rest days. No shutdown windows.",
            ...
            "Ready when you are — visit pzhisen.online and put your AI team online.",
        ],
    },
    {
        "id": "v4",
        ...
        "pitch": "+3Hz",
        "cues": [
            "What's good — Grant here. I'm a U.S.-based growth lead who ships organic reach systems for modern brands.",
            "In this quick walkthrough I'll show exactly how anyone can run Pzhisen at pzhisen.online as a full AI marketing engine.",
    ...
    },
    {
        ...
        "pitch": "+5Hz",
        "cues": [
            "Hello, I'm Logan — an American marketing leader focused on scalable automation for founders nationwide.",
...
async def build_version(ver: dict) -> float:
    ...
    with tempfile.TemporaryDirectory(prefix=f"pzhisen-v4-{vid}-tts-") as tmp:
        tmp_path = Path(tmp)
        parts: list[Path] = []
