#!/usr/bin/env python3
"""Build NEW 5 vertical EN promo MP4s — pack v4 (unique presenters/scripts/UI vs prior packs)."""
...
VERSION_META = [
    {
        ...
        "name": "Derek",
        "title": "Meet Derek",
        # Different cut rhythm vs prior packs
        "beats": [
            ("front", 0.00, 0.07),
            ("gesture", 0.07, 0.13),
            ("title", 0.13, 0.20),
        ...
        "subtitle_primary": "&H00F0FDFA",
        "drift_cycle": ["center", "up", "left", "center", "up", "left", "center", "up", "left", "center", "up", "center"],
        "zoom_alt": True,
    },
    {
        "id": "v2",
        ...
        "drift_cycle": ["left", "center", "up", "left", "center", "up", "left", "center", "up", "left", "center", "up"],
        "zoom_alt": False,
    },
    {
        "id": "v3",
        ...
        "subtitle_primary": "&H00FFFBEB",
        "drift_cycle": ["center", "left", "center", "up", "center", "left", "up", "center", "left", "up", "center"],
        "zoom_alt": True,
    },
    {
        "id": "v4",
        ...
        "drift_cycle": ["up", "left", "center", "up", "left", "center", "up", "left", "center", "up", "center"],
        "zoom_alt": False,
    },
    {
        "id": "v5",
        ...
        "subtitle_fs": 35,
        "subtitle_margin_v": 145,
        "subtitle_primary": "&H00F8FAFC",
        "drift_cycle": ["center", "up", "center", "left", "up", "center", "left", "up", "center", "left", "center"],
        "zoom_alt": True,
    },
]
...
def build_one(meta: dict) -> Path:
    ...
    outfile = OUT_DIR / f"pzhisen-promo-en4-{vid}-vertical.mp4"

    scenes = scene_plan(duration, ver_dir, meta)
    print(f"\n=== Building v4 {vid} ({meta['name']}) {duration:.1f}s vertical ===")

    drifts = meta["drift_cycle"]
    zoom_alt = meta["zoom_alt"]
    # Per-version zoom speed for fingerprint diversity
    zoom_speed = {"v1": 0.00095, "v2": 0.00120, "v3": 0.00085, "v4": 0.00135, "v5": 0.00105}[vid]

    with tempfile.TemporaryDirectory(prefix=f"pzhisen-en4-{vid}-") as tmp:
        tmp_path = Path(tmp)
        clips: list[Path] = []
...
def main() -> None:
    ...
    for meta in VERSION_META:
        if only != "all" and only != meta["id"]:
            continue
        build_one(meta)
    print("\nAll v4 unique vertical videos built.")
